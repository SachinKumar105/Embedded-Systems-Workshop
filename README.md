...
![NodeMCU pin layout](nodemcu_pins.png){width="5.1cm"}

<span>NodeMCU Specifications</span> ![image](nodeMCUtable.png){width="7.1cm"}
...
![image](ESP32-vs-ESP8266.jpg){width="7.1cm"}

Nova PM2.5 - PM10 (SDS011)
==========================

<span>Nova PM2.5 - PM10 (SDS011)</span> The SDS011 using principle of laser scattering,can get the particle concentration between 0.3 to 10μm in the air. It gives direct digital output via serial protocol at 9600bps and also over 2 PWM channels. There is a built-in fan for stable and reliable operations. ![image](Nova.jpg){width="6.1cm"}

<span>Nova PM2.5 - PM10 (SDS011) Specifications</span> ![image](Novaspecs.png){width="7.1cm"}
...
<span>SDS011 vs SPS30</span> ![image](SPS30.jpg){width="7.1cm"}
...
<span>Grove multichannel gas sensor (MICS 6814) Pin Layout</span> ![image](GrooveMpins.png){width="7.1cm"}

<span>MICS 6814 vs MICS 4514</span> ![image](mics4514.jpg){width="4.1cm"}
...
<span>Grove - VOC and eCO2 Gas Sensor(SGP30)</span> The Grove-VOC and eCO2 Gas Sensor(SGP30) is an air quality detection sensor. This grove module is based on SGP30, provided TVOC(Total Volatile Organic Compounds) and CO2eq output for this module. ![image](SGP30.jpg){width="7.1cm"}

<span>Grove - VOC and eCO2 Gas Sensor(SGP30) Specifications</span> ![image](SGP30.png){width="6.1cm"}

<span>SGP30 Pin Layout</span> ![image](SGP30pin.png){width="10cm"}

<span>SGP30 vs CCS811</span> ![image](ccs811.jpg){width="5.1cm"}
